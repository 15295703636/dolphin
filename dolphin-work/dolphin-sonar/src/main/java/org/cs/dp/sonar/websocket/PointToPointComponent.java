...
@Slf4j
@Component
@ServerEndpoint(value = "/websocket/point/{token}")
@Order(value = 3)
public class PointToPointComponent {
    ...
    @OnOpen
    public void onOpen(Session session, @PathParam("token") String topic) {
    ...
    @OnMessage
    public void onMessage(Session session, String message, @PathParam("token") String topic) throws IOException {
