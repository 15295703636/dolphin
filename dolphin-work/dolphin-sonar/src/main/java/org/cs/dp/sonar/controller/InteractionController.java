...
public class InteractionController {
    ...
    public ReturnInfo editInteraction(@RequestBody AddInteractionBean param) {
        return iInteractionService.editInteraction(param);
    }

    @PostMapping("get")
    @ApiOperation(value = "查询互动管理", notes = "互动管理")
    public ReturnInfo getInteraction(@RequestBody RequestPage<SplitPageInfo, GetAppSchReqBean> param) {
