...
public class GenerateCodeAutoMain {
    ...
    public void editJavaBean(String genCfg) throws Exception {
        ...
        CreateADEG.modifyFileContent(javaPath, NAME + entityMapper, NAME + mapper);
        ...
        CreateADEG.modifyFileContent(xmlPath, NAME + entityMapper, NAME + mapper);
    }
}
        ...
        try {
            ...
            if (out != null) {
                try {
                    ...
                    log.info("FreeMarkUtil的out流关闭失败:" + e.getMessage());
                }
            }
        }
        return null;
