...
public class RestPartyLayout {
    ...
    private int autoScanInterval	;//	是	-	暂不启用，请填写固定值3.
    ...
    private Boolean isPersonal	;//	是	-	当会议分屏被改变时，如果此字段的值为true，则不会影响此分屏设置，如果值为false，则会被新的会议分屏覆盖。
    private Boolean padNull	;//	是	-	对于未指定要显示的与会者的窗口，是否不显示任何内容
